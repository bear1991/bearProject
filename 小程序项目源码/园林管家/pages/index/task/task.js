...
Page({
  ...
  //任务确认详情页
  catchTaskdetailTap:function(event){
    //console.log(event);
    var taskDetail = JSON.stringify(event.currentTarget.dataset.taskdetail);
    wx.navigateTo({
      url: './taskdetail/taskdetail?taskDetail=' + taskDetail,
    })
  },
  ...
  dataContent: function (options, bool){
    var param = {
      requestUrl: app.globalData.linkIp + '/contractPlan/contractPlanlist',
      option: options,
      strCont: 'contractPlanList',
      obj: this
    };
