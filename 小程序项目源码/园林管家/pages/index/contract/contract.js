// pages/index/contract/contract.js
...
Page({
  ...
  //合同详情
  catchContractdetailTap: function(event){
    //console.log(event);
    var contractDetail = JSON.stringify(event.currentTarget.dataset.contractdetail);
    wx.navigateTo({
      url: './contractdetail/contractdetail?contractDetail=' + contractDetail,
    })
  },
