  ...
  <div class="ratingsWrapper" ref="ratingsWrapper">
    <div class="ratings-content">
      ...
      <div class="evaluation">
        <div class="classify">
          <span v-for="(item,index) in classifyArr" v-bind:key="index" class="item" :class="{'active':item.active,'bad':index==2,'badActive':item.active&&index==2}" @click="filterEvel(item)">
        ...
        <div class="evel-list">
          <ul>
            <li class="evel" v-for="evel in comments" v-bind:key="evel">
              <div class="avatar">
              ...
              <div class="content">
                ...
                <div class="recommend">
                  ...
                  <span class="dish" v-for="dish in evel.recommend" v-bind:key="dish">{{dish}}</span>
                </div>
              </div>
            </li>
          </ul>
