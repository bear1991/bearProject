<template>
  <div class="seller-wrapper" ref="sellerWrapper">
    <div class="seller-content">
      ...
      <div class="supports">
        <ul>
          <li class="item" v-for="item in seller.supports" v-bind:key="item">
      ...
      <div class="seller-imgs">
        ...
        <div class="img-wrapper" ref="picsWrapper">
          <div ref="picList">
            <img v-for="pic in seller.pics" v-bind:key="pic" :src="pic" width="120" height="90">
          </div>
        </div>
      </div>
      <div class="divider"></div>
      <div class="seller-info">
        <h1>商家信息</h1>
        <ul class="info-list">
          <li class="info" v-for="info in seller.infos" v-bind:key="info">{{info}}</li>
        </ul>
      </div>
    </div>
  </div>
